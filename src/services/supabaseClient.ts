...
export const supabaseUrl = (viteEnv.VITE_SUPABASE_URL as string | undefined) || defaultSupabaseUrl;
export const supabaseAnonKey = (viteEnv.VITE_SUPABASE_ANON_KEY as string | undefined) || defaultSupabasePublishableKey;
